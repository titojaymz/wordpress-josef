...
function rock_star_customize_register( $wp_customize ) {
	...
	$color_schemes = rock_star_color_scheme_options();
	$choices = array();
	foreach ( $color_schemes as $color_scheme ) {
		$choices[$color_scheme['value']] = $color_scheme['label'];
	}
	...
	//News Ticker
	require get_template_directory() . '/inc/customizer-includes/news-ticker.php';
...
function rock_star_customize_preview() {
	wp_enqueue_script( 'rock_star_customizer', get_template_directory_uri() . '/js/customizer.min.js', array( 'customize-preview' ), '20120827', true );
...
function rock_star_customize_scripts() {
	wp_enqueue_script( 'rock_star_customizer_custom', get_template_directory_uri() . '/js/customizer-custom-scripts.min.js', array( 'customize-controls', 'iris', 'underscore', 'wp-util' ), '20150630', true );
