				...
				<section class="' . $sliderclass . '">
					<div class="wrapper">
						<div class="cycle-slideshow"
							...
							// Select Slider
							if ( $sliderselect == 'demo-featured-slider' && function_exists( 'rock_star_demo_slider' ) ) {
								$output .=  rock_star_demo_slider( $options );
							}
							else if ( $sliderselect == 'featured-post-slider' && function_exists( 'rock_star_post_slider' ) ) {
								$output .=  rock_star_post_slider( $options );
							}
							elseif ( $sliderselect == 'featured-page-slider' && function_exists( 'rock_star_page_slider' ) ) {
								$output .=  rock_star_page_slider( $options );
							}
							elseif ( $sliderselect == 'featured-category-slider' && function_exists( 'rock_star_category_slider' ) ) {
								$output .=  rock_star_category_slider( $options );
							}
							elseif ( $sliderselect == 'featured-image-slider' && function_exists( 'rock_star_image_slider' ) ) {
